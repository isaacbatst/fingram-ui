  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "bg-[var(--color-bg-elevated)] border-t border-[var(--color-border-strong)] fixed inset-x-0 bottom-0 z-50 mt-24 flex max-h-[82vh] flex-col rounded-t-[20px]",
          className
        )}
        {...props}
      >
...
function DrawerFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex gap-3 px-5 pb-6 pt-3", className)}
      {...props}
    />
  )
}
